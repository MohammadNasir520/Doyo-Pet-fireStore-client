...
const Home = () => {
    ...
    return (
        ...
        <div>
            ...
            <div className='grid place-items-center md:grid-cols-3 lg:grid-cols-4 min-h-screen gap-3 mt-1'>
                {
                    users?.map(user => <div
                        key={user.id}

                        className='w-64 h-90 bg-slate-200 shadow-2xl rounded-xl'
                    >
                        ...
                        <div className='flex justify-center gap-4'>
                            ...
                            <Link to={`/editUser/${user.id}`} state={user}>
